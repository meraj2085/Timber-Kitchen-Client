...
const Reviews = () => {
  ...
  return (
    <div className="lg:flex justify-between mx-20 my-20">
      <div>
        <h1 className="text-3xl"><span className="text-orange-600 font-semibold">|</span> Customer reviews</h1>
        <div className="flex my-3">
          ...
          <div className="mb-3">
               ...
               <p>If you have used this product, share your thoughts with <br /> other customers.</p>
          </div>
          <form onSubmit={handleReview}>
               <textarea name="review" id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
               <div className="flex justify-center mt-5">
               <button type="submit" className="px-8 py-1 mb-5 font-semibold border rounded border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-gray-100">Submit</button>
               </div>
          </form>
      </div>
